...
btnScrollTo.addEventListener("click", function () {
  section1.scrollIntoView({ behave: "smooth" })
});
...
if(e.target.classList.contains("nav__link")){
  ...
  document.querySelector(id).scrollIntoView({ behave: "smooth" });
}
});
...
const sectionObserver=new IntersectionObserver(showSection,{root:null,threshold:0.15})
